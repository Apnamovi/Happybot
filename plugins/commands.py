...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('👻 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ', url="https://t.me/The_Happy_Hour_Hindi"),
...
#                      InlineKeyboardButton("ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ", url="https://t.me/+4nzja42ELQwzOWVl")
            ...
            filesarr.append(msg)
        await message.reply_text(text="<b>Your All Files/Videos Successfully Send</b>")
        return    
...
#        InlineKeyboardButton("Get File Again", callback_data=f'delfile#{file_id}')
#    ]]
#    await message.reply_text(text="<b>Your File/Video is successfully deleted!!!\n\nClick below button to get your deleted file 👇</b>")
    return   
